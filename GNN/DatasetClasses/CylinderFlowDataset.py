...
class CylinderFlowDataset(Dataset):
    ...
    Pressure is included as an input
    output_type affects all variables
    ...
    def __init__(self, 
        ...
        **kwargs): 
        ...
        graph = Data(pos=torch.from_numpy(node_coordinates.astype(np.float32)),
    ...
    def __getitem__(self, idx):
        ...
        node_data, outputs = get_sample(self.data, self.source_nodes,
